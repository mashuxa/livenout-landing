...
export default function Map({ onOpenFeed }) {
  return (
    ...
    >
      ...
      <button
        type="button"
        className="absolute bottom-6 left-1/2 z-10 w-fit -translate-x-1/2 whitespace-nowrap rounded-full bg-white px-5 py-2.5 text-sm font-semibold text-black shadow-lg"
        onClick={() => onOpenFeed()}
      >
